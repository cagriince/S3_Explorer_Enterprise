...
public class IconProvider {
    ...
    public static ImageIcon ICON_CUT_NORMAL = createImage("src/main/resources/icons/cut.png", 16);
    public static ImageIcon ICON_CUT_REVERSE = createImage("src/main/resources/icons/cut-reverse.png", 16);
    public static ImageIcon ICON_PASTE = null;
    public static ImageIcon ICON_PASTE_NORMAL = createImage("src/main/resources/icons/paste.png", 16);
    public static ImageIcon ICON_PASTE_REVERSE = createImage("src/main/resources/icons/paste-reverse.png", 16);
    public static ImageIcon ICON_COPY = null;
    public static ImageIcon ICON_COPY_NORMAL = createImage("src/main/resources/icons/copy.png", 16);
    public static ImageIcon ICON_COPY_REVERSE = createImage("src/main/resources/icons/copy-reverse.png", 16);
    ...
    public static ImageIcon ICON_REPOSITORY_NORMAL = createImage("src/main/resources/icons/db.png", 20);
    public static ImageIcon ICON_REPOSITORY_REVERSE = createImage("src/main/resources/icons/db-reverse.png", 20);
    public static ImageIcon ICON_BUCKET = null;
    public static ImageIcon ICON_BUCKET_NORMAL = createImage("src/main/resources/icons/hdd.png", 24);
    public static ImageIcon ICON_BUCKET_REVERSE = createImage("src/main/resources/icons/hdd-reverse.png", 24);
    public static ImageIcon ICON_SETTINGS = null;
    public static ImageIcon ICON_SETTINGS_NORMAL = createImage("src/main/resources/icons/settings.png", 16);
    public static ImageIcon ICON_SETTINGS_REVERSE = createImage("src/main/resources/icons/settings-reverse.png", 16);
    public static ImageIcon ICON_CANCEL = null;
    public static ImageIcon ICON_CANCEL_NORMAL = createImage("src/main/resources/icons/cancel.png", 16);
    public static ImageIcon ICON_CANCEL_REVERSE = createImage("src/main/resources/icons/cancel-reverse.png", 16);
